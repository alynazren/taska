        ...
        <div class="col-lg-6 col-7">
          ...
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
              <li class="breadcrumb-item"><a href="{{ url('/users') }}">Students Parents Records</a></li>
            </ol>
          </nav>
        </div>
            ...
            <tr>
              ...
              <td>
                ...
                <div class="avatar-group">
                  ...
                  <a href="#" class="avatar avatar-sm rounded-circle" data-toggle="tooltip" data-original-title="{{ $child->name }}">
